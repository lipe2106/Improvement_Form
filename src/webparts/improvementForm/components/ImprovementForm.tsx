...
const Form = (props:IImprovementFormProps) => {
  ...
  return(
      <div>
          <h1 className={styles.h1}>Improvement Form</h1>
          <p>Anything on the new intranet in need of an update, a link not working or you have a suggestion for a new link to be added? Please send in an improvement suggestion and we will have a look. Thank you!</p>
          <form>
              <div>
                  <Label>Title</Label>
                  <TextField
